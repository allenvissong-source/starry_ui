          ...
          TextSpan(children: [
            ...
            if (note != null)
              TextSpan(
                  text: '  $note',
                  style: TextStyle(
                      fontSize: 11, color: s.textDisabled)),
          ]),
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(
              color: Color(0x0A17171D), blurRadius: 24, offset: Offset(0, 6)),
        ],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Text(subtitle,
              style: TextStyle(
                  fontSize: 12.5, height: 1.6, color: s.textTertiary)),
...
class ColorsFoundation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const secondaryNames = [
      'secondary50', 'secondary100', 'secondary200', 'secondary300',
      'secondary400', 'secondary500', 'secondary600', 'secondary700',
      'secondary800', 'secondary900',
    ];
    const ctaNames = [
      'cta50', 'cta100', 'cta200', 'cta300', 'cta400',
      'cta500', 'cta600', 'cta700', 'cta800', 'cta900',
    ];
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
              fontSize: 13, height: 1.6, color: s.textSecondary),
        ),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            SizedBox(width: 200, child: Text('变量 Token',
                style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: role.textPrimary))),
            SizedBox(width: 180, child: Text('Light 浅色模式',
                style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: role.textPrimary))),
            SizedBox(width: 180, child: Text('Dark 深色模式',
                style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: role.textPrimary))),
          ],
        ),
        const SizedBox(height: 8),
              ...
              children: [
                SizedBox(
                    ...
                    child: Text(role.$1,
                        style: TextStyle(
                            fontSize: 13,
                            color: Theme.of(context).extension<StarryTokens>()!.semantic.textSecondary,
                            fontFeatures: [FontFeature.tabularFigures()]))),
                SizedBox(
                    width: 180,
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(
                                    e.$2 > 28 ? 28 : e.$2),
                                border:
                                    Border.all(color: const Color(0xFFC9BBFF)),
                              ),
                            ),
                            const SizedBox(height: 12),
                            Text(e.$1,
                                style: TextStyle(
                                    ...
                                    color: s.textPrimary)),
                            const SizedBox(height: 2),
                            Text('${e.$2.toStringAsFixed(0)} px',
                                style: TextStyle(
                                    fontSize: 11, color: s.textTertiary)),
                          ],
                        ),
                      ),
                  ],
    ...
    return _FoundationScaffold(
      children: [
            _SectionCard(
              ...
              children: [
                LayoutBuilder(
                  builder: (context, c) => panels(c.maxWidth >= 780),
                ),
              ],
            ),
      ],
...
class _ShadowPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final panelBorder =
        dark ? const Color(0x1FFFFFFF) : const Color(0xFFE4E4E9);
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          entry.$1,
                          style:
                              entry.$2.textStyle.copyWith(color: s.textPrimary),
                        ),
                        ...
                        Text(
                          ...
                          style:
                              TextStyle(fontSize: 11, color: s.textTertiary),
                        ),
                      ],
                    ),
                  ),
                      ...
                      children: [
                        ...
                        Text(
                          entry.$2 > 0
                              ...
                              : '0 px（无间距）',
                          style:
                              TextStyle(fontSize: 11.5, color: s.textTertiary),
                        ),
                      ],
                    ),
                  ),
      ...
      children: [
        _SectionCard(
          ...
          children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(r.$2,
                        style: TextStyle(
                            fontSize: 12.5, color: s.textSecondary)),
                  ],
                ),
              ),
            const SizedBox(height: 12),
            ...
            Text('durationMedium · easingStandard',
                style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w600,
                    color: s.textTertiary)),
...
({String label, Color bg, Color fg}) _rating(double ratio) {
  if (ratio >= 7) {
    return (label: 'AAA', bg: const Color(0xFFDCFCE7), fg: const Color(0xFF15803D));
  } else if (ratio >= 4.5) {
    return (label: 'AA', bg: const Color(0xFFFEF3C7), fg: const Color(0xFFB45309));
  } else if (ratio >= 3) {
    return (label: 'AA大', bg: const Color(0xFFE0F0FF), fg: const Color(0xFF245CC7));
  }
  return (label: '不足', bg: const Color(0xFFFEE2E2), fg: const Color(0xFFDC2626));
}
...
class _ContrastCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Text('${ratio.toStringAsFixed(1)} · ${r.label}',
              style: TextStyle(
                  fontSize: 12,
                  fontWeight: FontWeight.w700,
                  color: r.fg)),
            ...
            _SectionCard(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                      fontSize: 11.5, height: 1.6, color: s.textTertiary),
                ),
              ],
            ),
      ],
